    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <footer className="bg-white border-t py-6">
                <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-4">
                    <div className="font-bold text-[#2563eb] text-lg">ZoomRide</div>
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex gap-3">
                            <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">f</a>
                            <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">in</a>
                            <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">ig</a>
                        </div>
                    </div>
                </div>
            </footer>

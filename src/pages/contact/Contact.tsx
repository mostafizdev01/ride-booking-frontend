...
export default function ContactPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-gray-800 flex flex-col items-center p-6">
            {/* Header */}
            <motion.div
            ...
            >
                {[Facebook, Instagram, Linkedin, Twitter].map((Icon, i) => (
                    <a
                        key={i}
                        href="#"
                        className="p-3 rounded-full bg-blue-100 hover:bg-blue-600 hover:text-white transition-all shadow-sm"
                    >
            ...
            <p className="text-center text-gray-500 mt-10 mb-6">
                Your feedback drives us forward. Thanks for being part of ZoomRide.
            </p>
        </div>
    );
}
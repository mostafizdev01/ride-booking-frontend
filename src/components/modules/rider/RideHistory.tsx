    ...
    const mockRides: Ride[] = [
      {
        ...
        driver: {
          ...
          phone: "+1234567890",
          rating: 4.8,
          vehicleDetails: { make: "Toyota", model: "Camry", licensePlate: "ABC123", color: "White" },
        },
      },
      {
        id: "ride-002",
        ...
        driver: {
          ...
          phone: "+1234567891",
          rating: 4.9,
          vehicleDetails: { make: "Honda", model: "Civic", licensePlate: "XYZ789", color: "Blue" },
        },
      },
      {
        id: "ride-003",
                ...
                <Dialog key={ride.id}>
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      ...
                      <DialogDescription>Ride #{ride.id}</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-6">
                      {/* Status and Date */}
                      <div className="flex items-center justify-between">
                        {getStatusBadge(ride.status)}
                        <span className="text-sm text-muted-foreground">
                          {format(new Date(ride.createdAt), "EEEE, MMMM dd, yyyy 'at' h:mm a")}
                        </span>
                      </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-muted rounded-full flex items-center justify-center">
                              <span className="font-semibold">{ride.driver.name.charAt(0)}</span>
                            </div>
                            <div className="flex-1">
                              <p className="font-medium">{ride.driver.name}</p>
                              <p className="text-sm text-muted-foreground">
                                {ride.driver.vehicleDetails.color} {ride.driver.vehicleDetails.make}{" "}
                                {ride.driver.vehicleDetails.model} • {ride.driver.vehicleDetails.licensePlate}
                              </p>

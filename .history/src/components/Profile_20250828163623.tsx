            ...
            <DropdownMenu
                trigger={
                    <button className="flex items-center space-x-3 rounded-lg dark:hover:bg-zinc-800 transition-colors">
                        <div tabIndex={0} className="p-3 focus:ring-3 ring-white text-xl cursor-pointer bg-gradient-to-br from-lime-300 to-red-600 rounded-full flex items-center justify-center text-white font-semibold">
                            <FaRegUserCircle />
                        </div>

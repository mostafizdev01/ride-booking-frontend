        ...
        <div>
            <header className="relative items-center self-start box-border flex justify-between w-full z-[2] mx-auto px-4 py-2 md:px-8 md:py-6">
                <a href="" className="text-neutral-500 box-border block underline">
                    <img src={TextLogo} alt="Icon" className=" w-20 box-content block h-auto align-middle md:aspect-auto md:box-border md:inline md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:align-baseline md:w-[498px] md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]" />
                </a>

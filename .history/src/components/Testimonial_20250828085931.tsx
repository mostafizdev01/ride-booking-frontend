...
function Testimonial2() {
    ...
    return (
        <div className="font-sans flex flex-col items-center py-16 sm:px-6 bg-red-50">
            {/* Main Heading */}
            ...
            <div className="w-full max-w-7xl columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4 bg-red-100">

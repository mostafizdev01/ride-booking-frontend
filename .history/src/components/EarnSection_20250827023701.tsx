        ...
        <>
            ...
            {earningSections.map((section) => (
                <section key={section.id} className="box-border caret-transparent break-words bg-white mb-10 rounded-3xl">
                    <div className="items-center box-border caret-transparent flex flex-col grow shrink-0 break-words">
                                ...
                                <div role="tabpanel" className={section.tabPanelClassName}>
                                    <div className="box-border caret-transparent gap-x-8 flex basis-auto flex-col justify-start break-words gap-y-8 w-full">
                                        ...
                                        <div className="box-border caret-transparent gap-x-4 flex flex-col justify-start break-words gap-y-4 w-full md:flex-row md:w-auto">
                                            <a href={section.href} className="text-white text-lg font-[650] items-center bg-[#9AE600] box-border caret-transparent gap-x-3 flex shrink-0 h-12 justify-center tracking-[-0.252px] leading-[26px] break-words gap-y-3 text-center decoration-[oklab(0.423855_-0.10176_0.0613628_/_0.172549)] decoration-1 underline-offset-[2.45px] align-top px-6 rounded-lg md:text-xl md:tracking-[-0.34px] md:underline-offset-[2.5px]">{section.linkText}</a>
                                        </div>
                                    </div>

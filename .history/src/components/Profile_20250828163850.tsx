            ...
            <DropdownMenu
                trigger={
                    <button className="flex items-center space-x-3 rounded-lg dark:hover:bg-zinc-800 transition-colors">
                        <div tabIndex={1} className="p-3 active:ring-3 ring-white text-xl cursor-pointer bg-gradient-to-br from-lime-500 to-red-400 rounded-full flex items-center justify-center text-white font-semibold">
                            <FaRegUserCircle />
                        </div>

...
import TextLogo from "../assets/images/TextAndLogo.png"
...
export default function Header() {
    ...
    return (
        <div>
            <header className="bg-red-50 relative items-center self-start box-border flex justify-between w-full z-[2] mx-auto px-4 py-2 md:px-8 md:py-6">
                <a href="" className="text-neutral-500 box-border block underline">
                    <img src={TextLogo} alt="Icon" className=" md:w-50 box-content align-middle md:aspect-auto md:box-border md:inline md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:align-baseline md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]" />
                </a>
                <div className="items-center box-border flex ml-2">
                    <div className="box-border w-full">
                        <div className="relative box-border flex justify-end mr-4">
                            ...
                            <div className={`absolute bg-white shadow-[rgba(0,0,0,0.08)_0px_8px_32px_0px] box-border hidden flex-col z-[1000] overflow-auto rounded-lg top-[50px]`}>

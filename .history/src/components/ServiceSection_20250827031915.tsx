    ...
    return (
        <section className="box-border rounded-3xl mt-30">
            <div className="">
                ...
                <div className="grid grid-cols-1 bg-white lg:p-10 rounded-3xl md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {cities.map((city, index) => (
                        ...
                        >
                            <div className="relative overflow-hidden rounded-2xl aspect-[4/3]">
                                ...
                                <div className="absolute bottom-[1px] pl-3 bg-gradient-to-t text-white from-black to-transparent h-20 w-full">

...
export function BookingForm() {
    ...
    return (
        <div className="flex justify-center px-4 md:px-8 mt-10 md:mt-0">
            <form
                onSubmit={handleSubmit}
                className="bg-white shadow-md rounded-3xl p-6 md:p-10 w-full max-w-[1400px] space-y-6"
            >
                {/* Ride Type */}
                <div className="md:flex gap-3 md:w-lg">
                    {['private', 'shared'].map(type => (
                        <button
                            key={type}
                            type="button"
                            className={`flex-1 py-3 w-full mb-3 rounded-full text-md md:text-base font-medium ${rideType === type
                                    ? 'bg-lime-500 text-white'
                                    : 'bg-neutral-100 text-lime-500'
                ...
                <div className="flex flex-col md:flex-row md:gap-4 items-end">
                    ...
                    {/* Find a driver */}
                    <div className="mt-4 md:mt-0 flex-2 w-full">
                        <button
                            type="submit"
                            className="bg-lime-400 w-full cursor-pointer text-black rounded-lg px-6 py-[14px] font-medium hover:bg-lime-500 transition"
                        >
                            Find a driver
                        </button>
                    </div>

    ...
    return (
        <div>
            <header className="bg-red-50 relative items-center self-start box-border flex justify-between w-full z-[2] mx-auto px-4 md:px-8">
                <a href="" className="text-neutral-500 box-border underline">
                    <img src={TextLogo} alt="Icon" className=" md:w-50 h-50 box-content align-middle md:aspect-auto md:box-border md:inline md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:align-baseline md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]" />
                </a>

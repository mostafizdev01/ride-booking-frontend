...
export function BookingForm() {
    ...
    return (
        <div className="flex justify-center px-4 md:px-8 w-lg">
            <form
            ...
            >
                ...
                <div className="flex gap-3">
                    {['private', 'shared'].map(type => (
                        <button
                            key={type}
                            type="button"
                            className={`flex-1 py-2 rounded-2xl text-md md:text-base font-medium ${rideType === type
                ...
                <div className="flex flex-col md:flex-row md:gap-4 items-end">
                    ...
                    <div className="mt-4 md:mt-0 flex-2">
                        <button
                            type="submit"
                            className="bg-lime-400 w-full cursor-pointer text-black rounded-lg px-6 py-3 font-medium hover:bg-lime-500 transition"
                        >
                            Find a driver
                        </button>
                    </div>

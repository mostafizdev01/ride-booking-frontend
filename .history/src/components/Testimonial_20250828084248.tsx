...
function Testimonial2() {
    ...
    return (
        <div className="font-sans flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-neutral-900 mb-3xl text-4xl font-bold box-border inline-block leading-9 text-center w-full z-0 font-agrandir md:text-[64px] md:leading-[64px]">
                Riders Love Us
            </h2>

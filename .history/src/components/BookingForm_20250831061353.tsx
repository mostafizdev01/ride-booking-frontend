    ...
    return (
        <div className="flex justify-center px-4 md:px-8">
            <form
                ...
                className="bg-white shadow-md rounded-3xl p-6 md:p-10 w-full max-w-[1200px] space-y-6"
            >
                {/* Ride Type */}
                <div className="flex gap-3">
                    {['private', 'shared'].map(type => (
                        <button
                            key={type}
                            type="button"
                            className={`flex-1 py-2 rounded-2xl text-sm md:text-base font-medium ${rideType === type
                ...
                <div className="flex flex-col md:flex-row md:gap-4 items-end">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 border-2 border-neutral-200 rounded-lg overflow-hidden">
                            <button
                                ...
                                className="px-3 py-2 bg-neutral-100 disabled:opacity-50"
                            >
                                -
                            </button>
                            ...
                            <button
                                ...
                                className="px-3 py-2 bg-lime-400"
                            >
                                +
                            </button>
                        </div>
                    ...
                    <div className="mt-4 md:mt-0">
                        <button
                            type="submit"
                            className="bg-lime-400 text-white rounded-lg px-6 py-3 font-medium hover:bg-lime-500 transition"
                        >
                            Find a driver
                        </button>
                    </div>

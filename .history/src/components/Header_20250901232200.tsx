    ...
    return (
        <div>
            <header className=" relative items-center self-start box-border flex justify-between w-full z-[2] mx-auto px-4 md:px-8">
                <Link to="/" className="text-neutral-500 box-border underline">

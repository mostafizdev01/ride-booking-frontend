...
export const earningSections: readonly EarningSection[] = [
    {
        id: 'driver',
        subtitle: 'Earn money as a ZoomRide driver',
        ...
        imageAlt:
            'Person inside a Tesla holding a smartphone displaying the ZoomRide app navigation screen.',
    ...
    {
        id: 'courier',
        subtitle: 'Become a ZoomRide courier partner',
        ...
        imageAlt:
            'A ZoomRide Food courier in a green jacket, holding a phone and standing next to a bicycle, ready for delivery.',
    ...
    },
    {
        ...
        linkText: 'Register with ZoomRide Food',
        href: '/en/food/partner/',
        imageSrc: "https://c.animaapp.com/mesvu10d6tGVPE/assets/Index_DT_Media_16_9682e3376b_8e6086d7ac.webp",
        imageAlt:
            'Restaurant worker behind a bar counter displaying a smartphone with the ZoomRide Food delivery app.',
        tabPanelClassName: "relative items-center box-border caret-transparent gap-x-12 flex flex-col-reverse justify-start break-words gap-y-12 md:gap-x-28 md:flex-row-reverse md:gap-y-28",
    },
    {
        id: 'fleet',
        subtitle: 'Join ZoomRide with your fleet and earn more',
        title: 'Grow your transport business',
        description:
            'As a fleet owner and ZoomRide partner, you can manage your assets from one easy-to-use dashboard and grow your transport business.',
        ...
        imageAlt:
            'A driver wearing a grey knit hat and glasses smiling while sitting in a white and green ZoomRide vehicle.',
        tabPanelClassName: "relative items-center box-border caret-transparent gap-x-12 flex flex-col-reverse justify-start break-words gap-y-12 md:gap-x-28 md:flex-row md:gap-y-28",
    },
] as const;

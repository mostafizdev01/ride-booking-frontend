            ...
            <DropdownMenu
                trigger={
                    <button className="flex items-center space-x-3 rounded-lg dark:hover:bg-zinc-800 transition-colors">
                        <div tabIndex={0} className="p-3 focus:ring-3 ring-white text-xl cursor-pointer shadow-2xl rounded-full flex items-center justify-center text-black font-semibold">
                            <FaRegUserCircle />
                        </div>

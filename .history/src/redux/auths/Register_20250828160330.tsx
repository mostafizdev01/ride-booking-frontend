...
export default function Register() {
    ...
    return (
        ...
        <div className="relative w-full flex items-center justify-center font-sans overflow-hidden h-screen">
            ...
            <div className="relative w-full max-w-sm px-6 pb-6 space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
                <button onClick={closeFrom} className=' absolute right-0 top-0 py-1 px-2 text-xl bg-gray-50 cursor-pointer hover:bg-gray-100'>X</button>

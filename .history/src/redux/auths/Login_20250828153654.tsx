...
export default function Login() {
    ...
    return (
        ...
        <div className="relative w-full flex items-center justify-center font-sans overflow-hidden h-screen">
            ...
            <div className="relative w-full max-w-sm  space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
